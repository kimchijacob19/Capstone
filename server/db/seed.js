  ...
  try {
    ...
    await client.query(`
      ...
      VALUES
        ...
        -- Canada
        (${cities[28].id}, 'Parc du Bastion-de-la-Reine', 'A leafy stronghold on the old ramparts, where cannon-lined walls overlook the St. Lawrence.', 'https://github.com/kimchijacob19/Capstone/blob/main/server/public/images/Reine.jpeg?raw=true', 'both', 46.80910284568626, -71.20490716046093), -- Goblin Hill coords
