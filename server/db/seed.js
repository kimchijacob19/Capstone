  ...
  try {
    ...
    await client.query(`
      ...
      VALUES
        ...
        -- Canada
        (${cities[28].id}, 'Parc du Bastion-de-la-Reine', 'A leafy stronghold on the old ramparts, where cannon-lined walls overlook the St. Lawrence.', 'https://raw.githubusercontent.com/kimchijacob19/Capstone/refs/heads/main/server/public/images/de_la_Reine.jpeg', 'both'),
